...
class SellerEditProductView extends StatefulWidget {
  const SellerEditProductView({Key? key, required this.product})
      : super(key: key);
...
class _SellerEditProductViewState extends State<SellerEditProductView> {
  ...
  void initState() {
    ...
    controller.shippingPriceController.text =
                    ...
                    () => Row(
                      ...
                      children: List.generate(
                        ...
                        (index) => controller.images[index] != null
                            ...
                            : controller.imagesUrl.length >= index + 1 &&
                                    controller.imagesUrl[index] != null
                                ? CachedNetworkImage(
